...
dyn_aug('f_ccrftt_1', '1_finetune_cub', 'finetune_cub', 6)
dyn_aug('f_ccrftt_2', '2_finetune_cub', 'finetune_cub', 6)
dyn_aug('f_ccrftt_3', '3_finetune_cub', 'finetune_cub', 6)
dyn_aug('f_cccftt_1', '1_finetune_cub_cropped', 'finetune_cub_cropped', 6)
dyn_aug('f_cccftt_2', '2_finetune_cub_cropped', 'finetune_cub_cropped', 6)
dyn_aug('f_cccftt_3', '3_finetune_cub_cropped', 'finetune_cub_cropped', 6)
dyn_aug('f_ccphrf_def_unif_1', '1_finetune_cub_part_head_rf_new', 'finetune_cub_part', 6)
dyn_aug('f_ccpbrf_def_unif_1', '1_finetune_cub_part_body_rf_new', 'finetune_cub_part', 6)
dyn_aug('f_ccphrf_def_unif_2', '2_finetune_cub_part_head_rf_new', 'finetune_cub_part', 6)
dyn_aug('f_ccpbrf_def_unif_2', '2_finetune_cub_part_body_rf_new', 'finetune_cub_part', 6)
dyn_aug('f_ccphrf_def_unif_3', '3_finetune_cub_part_head_rf_new', 'finetune_cub_part', 6)
dyn_aug('f_ccpbrf_def_unif_3', '3_finetune_cub_part_body_rf_new', 'finetune_cub_part', 6)
dyn_aug('f_cccrf_ft_1', '1_finetune_cub_cropped_rf_cccftt', 'finetune_cub', 6)
dyn_aug('f_cccrf_def_1', '1_finetune_cub_cropped_rf_def', 'finetune_cub', 6)
dyn_aug('f_ccpbrf_ft_unif_1', 'finetune_cub_body_rf_cccftt_60000_unif', 'finetune_cub', 6)
dyn_aug('f_ccpbrf_def_norm_1', 'finetune_cub_body_rf_def_norm', 'finetune_cub', 6)
dyn_aug('f_ccpbrf_def_rand_1', 'finetune_cub_body_rf_def_rand', 'finetune_cub', 6)
